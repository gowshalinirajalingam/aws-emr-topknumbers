...
public class EmrTopkValues {
   ...
   public static class top_10_numbers_Mapper extends Mapper<Object,Text, Text, LongWritable> {
   ...
   public static class top_10_numbers_Reducer extends Reducer<Text, LongWritable, LongWritable, Text> {
                                       ...
                                       InterruptedException
    {
      ...
      public static void main(String[] args) throws Exception
      {
          ...
          job.setMapperClass(top_10_numbers_Mapper.class);
          job.setReducerClass(top_10_numbers_Reducer.class);
